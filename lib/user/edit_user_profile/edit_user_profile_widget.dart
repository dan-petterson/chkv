...
class _EditUserProfileWidgetState extends State<EditUserProfileWidget> {
  ...
  void initState() {
    ...
    _model.cityController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.locationName, ''));
    _model.cityFocusNode ??= FocusNode();

    _model.professionController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.jobPosition, ''));
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: AuthUserStreamWidget(
                    builder: (context) => TextFormField(
                      controller: _model.professionController,
                      ...
                      style: FlutterFlowTheme.of(context).bodyMedium,
                      validator: _model.professionControllerValidator
                          .asValidator(context),
                    ),
                  ),
                ),
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await currentUserReference!
                          ...
                          jobPosition: _model.professionController.text,
                          locationName: _model.cityController.text,
