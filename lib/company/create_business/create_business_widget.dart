...
class CreateBusinessWidget extends StatefulWidget {
  ...
  @override
  _CreateBusinessWidgetState createState() => _CreateBusinessWidgetState();
}
...
class _CreateBusinessWidgetState extends State<CreateBusinessWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<TypesOfCompanyRecord>>(
      stream: queryTypesOfCompanyRecord(),
      builder: (context, snapshot) {
        ...
        List<TypesOfCompanyRecord> createBusinessTypesOfCompanyRecordList =
            snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).secondaryBackground,
                ...
                Padding(
                  ...
                  child: FlutterFlowDropDown<String>(
                    controller: _model.stateValueController ??=
                      ...
                      _model.stateValue ??= 'Business category',
                    ),
                    options: createBusinessTypesOfCompanyRecordList
                        .map((e) => e.name)
                        .toList(),
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await CompanyRecord.collection
                            .doc()
                            .set(createCompanyRecordData(
                              name: _model.yourNameController.text,
                              locationName: _model.yourNameController.text,
